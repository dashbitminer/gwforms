...
(() => {
  ...
  Array.from(forms).forEach(form => {
    form.addEventListener('submit', event => {
      if (!form.checkValidity()|| !validarDis2()) {
        event.preventDefault()
        event.stopPropagation()

        // Opcional: mensaje visual si querés
        alert("Por favor seleccione al menos una discapacidad.");
      }
...
var hiddenDiv2 = document.getElementById("menor"); //menor de edad
var hiddenDiv9 = document.getElementById("brindo"); //menor edad
var hiddenDiv4 = document.getElementById("brindo2"); //info del participante
...
var hiddenDiv10 = document.getElementById("menor16"); //menor de edad fuera de programa
...
var input1= document.getElementById("nombreRep");
...
var input6= document.getElementById("aut");
//mayor de edad
...
var input7= document.getElementById("sedes");
  ...
  hiddenDiv9.classList.add("d-none");
  hiddenDiv10.classList.add("d-none");
  ...
  hiddenDiv9.classList.remove("d-none");
  hiddenDiv10.classList.add("d-none");
  ...
  input50.required = false;
      ...
      hiddenDiv.classList.add("d-none");
      hiddenDiv10.classList.remove("d-none");
    }
  }
...
var hiddenDiv = document.getElementById("hidden-question-div10");
  ...
  function validarDis2() {
    const hiddenDiv = document.getElementById("hidden-question-div10");
    const checkboxes = document.querySelectorAll('input[name="dis2"]');
  
    if (!hiddenDiv.classList.contains("d-none")) {
      return Array.from(checkboxes).some(cb => cb.checked);
    }
  
    return true; // Si el div está oculto, no se requiere validación
  }
...
var input50= document.getElementById("nacionalidad");
var input7= document.getElementById("sedes");
var input8= document.getElementById("numResp");
