...
var hiddenDiv = document.getElementById("DUIO");
hiddenDiv.classList.remove("d-none");
if(select.value==="Salvadoreño(a)"){    
  labelOutput.innerHTML = "Escribe el número de tu Documento Único de Identidad (DUI)"
  document.getElementById("DUI").placeholder = "00000000-0";
...
function ocultarExt(paisOrigen){
  var divext = document.getElementById("divext")
  var paisNac = document.getElementById("paisNac")
  if (paisOrigen == "1"){
    divext.classList.add("d-none");
    paisNac.required = false;
  }else{
    divext.classList.remove("d-none");
    paisNac.required = true;
  }
}