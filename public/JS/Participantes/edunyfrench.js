...
function validarClubs() {
  ...
  checkboxes.forEach(function(checkbox) {
    switch (checkbox.value) {
      case "1":
       clubtext = "Club de lecture";
       break;
      case "2":
        clubtext = "Mentorat par les pairs";
        break;
      case "3":
        clubtext = "Club de détente ou de pratique";
        break;
    }
      if (checkbox.checked) {
  ...
  if (!alMenosUnoSeleccionado) {
      alert('Vous devez sélectionner au moins un club.');
  ...
  xhr.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
          ...
          if(respuesta=="1"){
              ...
              window.location.href = "/educacion/ny/fr";
          }else if (respuesta=="-1"){
            alert("Votre réponse est déjà enregistrée");
              // redireccionar a la página de inicio
              window.location.href = "/educacion/ny/fr";
          }           
          else {
