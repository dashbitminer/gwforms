...
(() => {
  ...
  Array.from(forms).forEach(form => {
    ...
    var select = document.getElementById("firmap").value;
    var select2 = document.getElementById("firmat").value;
    ...
    var select = document.getElementById("aut4");
    var hiddenDiv = document.getElementById("divtel");
     input4 = document.getElementById("TM")
    if(select.value==="1"){
      hiddenDiv.classList.remove("d-none") ;
    ...
    function activaselect9(){
      var select = document.getElementById("desde");
      var hiddenDiv = document.getElementById("otrodiv");
      var input1=document.getElementById("otro");
      if(select.value==="4"){
        hiddenDiv.classList.remove("d-none") ;
...
function actualizarCiudades3(paisSeleccionado) {
  ...
  var ciudadSelect = document.getElementById("programa");
  document.getElementById("preguntasabadosdiv").classList.remove("d-none");
  document.getElementById("paisdiv").classList.add("d-none");
  ciudadSelect.innerHTML = ""; // Limpiar la lista de ciudades
  ...
  document.getElementById("preguntasabadosdiv").classList.add("d-none");
  document.getElementById("paisdiv").classList.remove("d-none");
}
}
...
function actualizarmun(paisSeleccionado) {
  ...
  ciudadSelect.innerHTML = ""; // Limpiar la lista de ciudades
  var sede = document.getElementById("programa");
...
// Datos de opciones dependientes
var opcionesProgramas = {
  3: [
    { label: "Cruz Roja Hondureña", value: "1795" },
    { label: "FUNADEH", value: "1112" },
    { label: "CASM", value: "1114" }
  ],
  4: [
    { label: "CEIPA", value: "1107" },
    { label: "Tierra Nueva", value: "1121" },
    { label: "CDRO", value: "1109" },
    { label: "Asociación Centro de Paz Barbara Ford", value: "1117" }
  ],
  7: [
    { label: "Escuelas Comunitarias", value: "-1" },
    { label: "Red Juvenil", value: "64" },
    { label: "Fablab", value: "70" },
    { label: "Jóvenes Constructores", value: "56" },
    { label: "Creando Profesionales", value: "55" }
  ]
};

var opcionesSesionesVirtuales = {
  3: [
    { label: "Desde casa", value: "1" },
    { label: "La escuela", value: "2" },
    { label: "Desde mi sede de JLI (CASM, Cruz Roja Hondureña, FUNADEH)", value: "5" },
    { label: "Otro", value: "4" }
  ],
  4: [
    { label: "Desde casa", value: "1" },
    { label: "La escuela", value: "2" },
    { label: "Desde mi sede de JLI (CEIPA, Tierra Nueva, CDRO, Asociación Centro de Paz Barbara Ford)", value: "6" },
    { label: "Otro", value: "4" }
  ],
  7: [
    { label: "Desde casa", value: "1" },
    { label: "La escuela", value: "2" },
    { label: "Edificio Henríquez", value: "3" },
    { label: "Otro", value: "4" }
  ]
};

// Función para cargar las opciones dependientes
function cargarProgramas() {
  // Obtener referencia a los elementos select
  var select1 = document.getElementById("pais");
  var select2 = document.getElementById("programa");
  var select3 = document.getElementById("desde");

  // Limpiar opciones previas en el select2
  select2.innerHTML = "";
  select3.innerHTML = "";
  ...
  // Obtener las opciones dependientes
  var opciones = opcionesProgramas[opcionSeleccionada];
  
  var opciones2 = opcionesSesionesVirtuales[opcionSeleccionada];

  if (opciones) {
    for (var i = 0; i < opciones2.length; i++) {
      var option = document.createElement("option");
      option.text = opciones2[i].label;
      option.value = opciones2[i].value;
      select3.add(option);
    }
  }
