...
(() => {
  ...
  if(select.value==="Salvadoreño(a)"){    
    labelOutput.innerHTML = "Escribe el número documento personal de identidad (DPI)*"
  ...
  function activaselect51(){
    ...
    if(select.value==="1"){    
      labelOutput.innerHTML = "Escribe el número documento personal de identidad (DPI)*"
      document.getElementById("DUI").placeholder = "0000000000000";
        } else {labelOutput.innerHTML = "Escribe el número de tu Documento de Identidad"
        document.getElementById("DUI").placeholder = ""
      } 
      } 
    ...
    function validateFormat() {
      var formatInput = document.getElementById("DUIM").value;
         var formatRegex = /^\d{13}$/;
            ...
            alertContainer.innerHTML = '<div class="alert alert-danger" role="alert">El formato del DPI no es válido.</div>';
