...
function activaselect11(){
  var select = document.getElementById("rjfor");
var hiddenDiv = document.getElementById("diplomado");
  if(select.value==="138"){    
...
function activaselect4(){
  ...
  var hiddenDiv6 = document.getElementById("negativoconsentimiento");
...
function actualizarmun(paisSeleccionado) {
  ...
  xhr.open("POST", "/obtenermunsede", true);
  xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function actualizarsede(paisSeleccionado) {
  ...
  xhr.open("POST", "/obtenersede", true);
  xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function Otro() {
  var radio = document.getElementById('organizacionOtro');
  var div = document.getElementById('otra_organizacion_div');
  var otraOrg = document.getElementById('otraOrganizacion')
  if (radio.checked) {
    div.classList.remove('d-none');
    otraOrg.required = true;
  } else {
    div.classList.add('d-none');
    otraOrg.required = false;
  }
}
