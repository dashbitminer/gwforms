...
(() => {
  ...
  hiddenDiv.classList.remove("d-none")
  if(select.value==="1"){    
    labelOutput.innerHTML ="Escribe el número de tu Documento Nacional de Identidad (DNI)";
    labelOutput2.innerHTML ="Toma una fotografía a tu documento nacional de identidad [DNI] (lado de enfrente) y súbelo en este espacio";
    labelOutput3.innerHTML ="Toma una fotografía a tu documento nacional de identidad [DNI] (lado de atras) y súbelo en este espacio";
