    ...
    function validateFormat() {
      var formatInput = document.getElementById("DUI").value;
      hideAlert()
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (opcionesCiudades==formatInput) {
            var alertContainer = document.getElementById("alertContainer");
            alertContainer.innerHTML = '<div class="alert alert-danger" role="alert">Participante con este DUI ya llenó el formulario.</div>';
    ...
    xhr.open("POST", "/voluntariadocheck", true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.send("pais=" + formatInput);
  }
    ...
    if(select.value==="1"){    
      ...
      labelOutput2.innerHTML ="Toma una fotografía a tu documento unico de identidad [DUI] (lado de enfrente) y súbelo en este espacio";
      labelOutput3.innerHTML ="Toma una fotografía a tu documento unico de identidad [DUI] (lado de atras) y súbelo en este espacio";
