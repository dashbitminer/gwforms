...
var input50=document.getElementById("departamento");
var input51=document.getElementById("municipio");
var input52=document.getElementById("sede");
...
function fdep(departamento){
  ...
  xhr.open("POST", "/sanamente/chemonics/mun", true);
  xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhr.send("departamento="+departamento);
}


function fmun(muncipio){
  var ciudadSelect = document.getElementById('sede');
  ciudadSelect.innerHTML = ""; // Limpiar la lista de ciudades
  ...
  xhr.open("POST", "/sanamente/chemonics/sede", true);
  xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhr.send("municipio="+muncipio);
}