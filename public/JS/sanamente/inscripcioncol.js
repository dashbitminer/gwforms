...
(() => {
    ...
    Array.from(forms).forEach(form => {
      ...
      event.preventDefault();
      alert("No se puede enviar el formulario mientras este incorrecto Cédula de Ciudadanía.");
    }
      }, false)
    })
  })()
  ...
  if(select.value==="1"){    
    labelOutput.innerHTML = "Escribe el número documento personal de identidad (Cédula de Ciudadanía)*"
    document.getElementById("DUIM").placeholder = "0000000000";
