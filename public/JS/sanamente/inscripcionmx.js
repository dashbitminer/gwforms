...
(() => {
  ...
  Array.from(forms).forEach(form => {
    ...
    event.preventDefault();
    alert("No se puede enviar el formulario mientras este incorrecto la cedula");
  }
    }, false)
  })
})()
...
function activaselect51(){
  ...
  if(select.value==="1"){    
    labelOutput.innerHTML = "Escribe el número Clave Única del Registro de Población (CURP)*"
...
function activaselect5(){
  ...
  var hiddenDiv1 = document.getElementById("acc3d");
  ...
  var input6 = document.getElementById("acc4");
  if(select.value==="10"){    
    hiddenDiv.classList.remove("d-none");
    ...
    function activaselect6(){
      ...
      if(select.value==="1"||select.value==="2"||select.value==="3"){    
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                var opcionesCiudades = this.responseText;
                input4.innerHTML = opcionesCiudades;
                // Get the <select> element
var selectElement = document.getElementById("acc3");

// Get the <option> element where value is "2"
var optionElement = selectElement.querySelector("option[value='2']");

// If the <option> element exists, change its text content
if (optionElement) {
  optionElement.textContent = "	Personal de la policía Estatal";
}
 // Actualizar la lista de ciudades
  ...
  if(select.value==="1"||select.value==="2"){    
    ...
    input4.innerHTML = ""; // Limpiar la lista de ciudades
// Get the <select> element
var selectElement = document.getElementById("acc4");
var optionElement = selectElement.querySelector("option[value='1']");
var optionElement2 = selectElement.querySelector("option[value='2']");
var optionElement3 = selectElement.querySelector("option[value='3']");
if (optionElement) {
  optionElement.textContent = "	Personal de la policía Estatal";
  optionElement2.textContent = "	Personal de la policía Estatal";
  optionElement3.textContent = "	Personal de la policía Estatal";
}
    // Enviar petición AJAX para obtener las ciudades correspondientes al país seleccionado
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function() {
