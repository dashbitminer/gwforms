...
(() => {
  ...
  Array.from(forms).forEach(form => {
    ...
    event.preventDefault();
    alert("No se puede enviar el formulario mientras este incorrecto el DPI");
  }
    }, false)
  })
})()
  ...
  function validateFormat() {
    var formatInput = document.getElementById("DUIM").value;
      ...
      if(select.value==="1"||select.value===""){
          ...
          alertContainer.innerHTML = '<div class="alert alert-danger" role="alert">El formato de la cédula no es válido.</div>';
...
if(select.value==="1"){    
  labelOutput.innerHTML = "Escribe el número de tu Cédula de Identidad:"
  document.getElementById("DUIM").placeholder = "000000000";
    ...
    document.getElementById("DUIM").placeholder = ""
      ...
      function activaselect54(){
        ...
        if(select.value==="1"){    
          document.getElementById("DUIP").placeholder = "000000000";
            } else {
